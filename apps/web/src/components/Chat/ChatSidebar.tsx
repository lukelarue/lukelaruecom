...
export const ChatSidebar = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // This fires BEFORE new messages are added, so small threshold is fine
      const threshold = 10;
  ...
  useLayoutEffect(() => {
    ...
    // For new messages, use isAtBottomRef which was set BEFORE the message was added to DOM
